...
function main() {
    ...
    scene.background = new THREE.Color(0.2, 0.4, 0.6); // Mengubah warna latar belakang
    ...
    const cubeTextureMap = textureLoader.load('image/kotak_texture.jpeg'); // Ganti dengan jalur ke tekstur kubus
